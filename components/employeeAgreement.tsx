...
//               className="inline-flex items-center gap-2 rounded-lg black-600 px-4 py-2 text-white hover:black-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
//             >
...
//                 <button onClick={() => handleDownload("doc")} className="inline-flex items-center gap-2 black-600 px-4 py-2 text-white hover:black-700 rounded-lg">
//                   <Download className="h-5 w-5" /> Download
//                 </button>
//                 {/* <button onClick={() => handleDownload("pdf")} className="inline-flex items-center gap-2 black-600 px-4 py-2 text-white hover:black-700 rounded-lg">
