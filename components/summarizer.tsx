...
//   // State for history
//   const folderName = "text-summarizer"; // Default folder name for the History API
...
//       setResponse(data.summary || "Generated summary will appear here.");
...
//           </button>
//           {isOpen && (
//             <div className="absolute mt-2 bg-white border border-gray-300 rounded-lg shadow-lg p-4 w-96">
//               {history.length > 0 ? (
//                 <ul className="bg-white" style={{position:'absolute', right:"0"}} >
//                   {history.map((file) => (
//                     <li key={file.name}>
