...
// //         <h1 className="text-xl font-semibold">BNS Search</h1>
// //         {documents.length > 0 && (
// //           <button
...
// // import { Send, X, FileText, Eye, Loader } from "lucide-react";
...
// //             ))}
// //           </div>
// //           <div className="flex-1 pl-4 flex items-center justify-center text-gray-500">
...
// //   const [, setIsResponseLoading] = useState<boolean>(false); // State for current response loading
...
// //     if (!inputValue.trim()) return;
// //     if (!sessionID) {
// //       setMessages(prev => [...prev, { content: "Error: No session ID found. Upload a document first.", timestamp: new Date(), isUser: false }]);
// //       return;
// //     }
...
// //       setMessages((prev) => [...prev, { content: response.data.response, timestamp: new Date(), isUser: false }]);
// //     } catch  {
// //       setMessages((prev) => [...prev, { content: "Error getting a response from the server.", timestamp: new Date(), isUser: false }]);
// //     } finally {
...
// //               className="px-4 py-2 bg-white text-black rounded-lg border-black  border hover:bg-gray-200 focus:outline-none"
// //             >
// //               History
// //             </button>
...
// //                     <ul className="history-list w-96 p-4 bg-white" style={{position:'absolute', right:"0"}} >
// //                       {chatHistory.map((file) => (
// //                         <li key={file.id} className="history-item " >
// //                           <a
// //                             href={file.url} // Ensure this matches the API response
// //                             target="_blank"
// //                             rel="noopener noreferrer"
...
// //                     </ul>
// //                   ) : (
// //                     <p className="px-2">No recent files found.</p>
// //                   )}
