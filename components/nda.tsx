...
//   //         setLeaseAgreement(data.lease_agreement);
//   //         setDocumentPath(data.document_path || null);
//   //       } else if (data.message) {
//   //         setMessages(prev => [
//   //             ...prev, 
//   //             { type: "question", content: data.message ?? "Unknown question" }
//   //           ]);
//   //       }
//   //     } catch (error) {
...
//     try {
//       const processResponse = await fetch('http://44.211.157.24:8000/nda_process_response', {
//         method: 'POST',
//         headers: {
//           'Content-Type': 'application/json',
//         },
...
//           setGenerating(false); // 🔵 Stop preloader after NDA is ready
//         }, 2000); // Simulating processing delay for better UX
//       } else if (data.message) {
...
//     try {
//       const response = await fetch(`http://44.211.157.24:8000/download?file_path=${encodeURIComponent(documentPath)}&format=${format}`);
...
//       a.href = url;
//       a.download = `NDA_Agreement.${format}`;
//       document.body.appendChild(a);
//       a.click();
//       document.body.removeChild(a);
//       window.URL.revokeObjectURL(url);
      
//       console.log(`Downloaded in ${format} format`);
//     } catch (error) {
...
//             <h2 className="text-xl font-semibold text-gray-900">NDA (Non Discloser Agreement)</h2>
//           </div>
//         </div>
//         {generating && (
...
//                 <div
//                   className={`max-w-[80%] rounded-lg p-3 ${msg.type === "answer"
...
//               className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
//             >
...
//                 <button onClick={() => handleDownload("doc")} className="inline-flex items-center gap-2 bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 rounded-lg">
//                   <Download className="h-5 w-5" /> Download
//                 </button>
//                 {/* <button onClick={() => handleDownload("pdf")} className="inline-flex items-center gap-2 bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 rounded-lg">
//                   <Download className="h-5 w-5" /> Download PDF
//                 </button> */}
//               </div>
//             </div>
//             {documentPath && <p className="text-sm text-gray-600">Document saved at: {documentPath}</p>}
//           </div>
//         )}
//       </div>
//     </div>
